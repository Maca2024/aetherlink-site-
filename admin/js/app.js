...
import { initAuth, handleLogin as authLogin, handleGoogleLogin as authGoogleLogin, handleLogout as authLogout } from './auth.js';
    ...
    app.innerHTML = `
        <div class="min-h-screen flex items-center justify-center p-6">
            <div class="glass rounded-2xl p-8 md:p-10 w-full max-w-md relative">
                ...
                <!-- Google Sign In -->
                <button id="google-login-btn" class="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.07] hover:border-white/20 transition-all duration-300 group">
